...
| 2 — لوحة التحكم | ✅ |
| 3 — المشاريع والأعضاء | ✅ |
| 4 — المالية والسجل المالي | ✅ |
| 5 — الذمم والالتزامات | ✅ |
| 6 — الأصول والمتابعات | ✅ |
| 7 — الطلبات والمستندات والاستبيانات | ✅ |
| 8 — الإشعارات وسجل التدقيق والمهام | ✅ |
| 9 — الإعدادات والتخصيص | ✅ |
| 10 — التحقق النهائي | ✅ |

**الخلاصة:** كل الشاشات الـ 23 أُعيد بناؤها بـ Vue 3 متّبعةً بنية `PROJECT_STRUCTURE.md`.
كل عنصر في القائمة الجانبية يفتح موديولاً حقيقياً. التحقق: `npm run typecheck` و`npm run build`
ينجحان بلا أخطاء، وكل المسارات (19) ترد 200 بلا أخطاء console.

**قرارات الإنهاء:** يبقى مجلد `legacy/` كمرجع مؤقت، ويبقى العمل على فرع `vue-test`
دون دمج في `main` (Vue على vue-test · React على main).
